...
try{
	 PreparedStatement ps=DBConnections.getConnection().prepareStatement(UtilQueries.DISPLAY_PAY_HISTORY1);
	 String Flatno=request.getParameter("fno1");
	 ps.setString(1,"Flatno");
	 
	 ResultSet rs = ps.executeQuery();
	 if(Flatno.equals(rs.getString("Flatno")))
	 {
	 while(rs.next())
	 {%>
